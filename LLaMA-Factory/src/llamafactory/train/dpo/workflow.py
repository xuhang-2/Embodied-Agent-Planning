...
from ...extras.ploting import plot_loss_dpo
    ...
    if training_args.do_train:
        ...
        if trainer.is_world_process_zero() and finetuning_args.plot_loss:
            metrics_groups = {
                ...
                "logps": ["logps/chosen", "logps/rejected"]
            }
            plot_loss_dpo(training_args.output_dir, metrics_groups)
            # plot_loss_dpo(training_args.output_dir, keys=["loss", "eval_loss", "rewards/accuracies","rewards/chosen","rewards/rejected","logps/rejected","logps/chosen"])
